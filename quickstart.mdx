...
Welcome to Beliquid! This guide will help you get started with our platform.

## Getting Started

To begin using Beliquid, you'll need to:
...
For detailed information about contract addresses, please visit our [Contract Addresses](/contract-addresses) page.
...
* Once you have an EVM wallet and assets on Berachain, go to https://app.beliquid.pro/trading
